...
┃ ⏳ Expired: ${new Date(order.expiresAt).toLocaleString("id-ID")}
┃
┗━━━━━━━━━━━━━━━━━━━━┛
...
_Mohon transfer sesuai nominal di atas._
`.trim();
}
...
${order.note ? `🎁 *DETAIL PRODUK / AKUN:*\n\n${order.note}` : "Terima kasih telah berbelanja!"}

_Simpan invoice ini sebagai bukti pembelian._
`.trim();
}
